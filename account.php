...
@media(max-width:520px){.account-card,.account-summary{padding:22px}.order-head{display:block}.order-link{display:inline-block;margin-top:13px}.order-meta{display:grid;gap:7px;margin-top:18px}}
</style>
