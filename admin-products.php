  ...
  <div class="product-list">
    ...
    <?php foreach ($visibleProducts as $p): $state = product_state($p); ?>
      <div class="product-row">
        <?php if ($p['image_url']): ?><a href="<?=admin_h($p['image_url'])?>" target="_blank" rel="noreferrer" title="Open full-size image"><img class="thumb" src="<?=admin_h($p['image_url'])?>" alt="<?=admin_h($p['name'])?>"></a><?php else: ?><span class="thumb-placeholder" aria-label="No product image">BL</span><?php endif; ?>
